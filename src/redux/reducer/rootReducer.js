import { DO_LOGIN, CHECK_LOGIN, LOGOUT, SEARCH_FRIEND, SET_SOCKET, GET_REQUEST, UPDATE_REQUEST,baseurl, GET_FRIEND, SEND_REQUEST, SET_CHAT, SET_ONLINE_CHAT } from "../action/action";
